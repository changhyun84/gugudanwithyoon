...
export const START_UNITS = {
  /* 수학은 학교 진도(2-3 원 · 2-4 분수)에 **곱셈과 나눗셈을 같이** 엽니다.
     원의 지름은 반지름 × 2이고 반지름은 지름 ÷ 2입니다. 분수를 비교하려면 곱셈을 합니다.
     연산이 막혀 있으면 원도 분수도 막힙니다 — 그런데 그 연습은 1학기 단원에 있습니다.
     진도는 학교가 정하지만 **무엇이 막혀 있는지는 부모가 봅니다** (구현-현황 38·39장). */
  수학:   ['1-3', '1-4', '2-3', '2-4'],
  한국사: ['1-3', '1-4'],
};
